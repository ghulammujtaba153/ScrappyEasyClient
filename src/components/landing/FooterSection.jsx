            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20 animate-slideUp">
                    ...
                    <div className="space-y-6">
                        <h4 className="font-black text-xl font-semibold text-gray-900">Company</h4>
                    ...
                    {/* Product Links */}
                    <div className="space-y-6">
                        <h4 className="font-black text-xl font-semibold text-gray-900">Product</h4>
                        <ul className="space-y-4">
                            {[
                                { label: "Features", path: "#" },
                                { label: "Careers", path: "#" },
                    ...
                    {/* Newsletter Section */}
                    <div className="space-y-6">
                        <h4 className="font-black text-xl font-semibold text-gray-900">Newsletter</h4>
                        ...
                        <div className="relative group">
                            ...
                            />
                            <button className="absolute right-1.5 top-1.5 bottom-1.5 bg-[#0F792C] hover:bg-[#0A5D21] text-white px-6 rounded-full font-black font-semibold text-sm flex items-center gap-2 transition-all group-hover:shadow-lg">
